CLASS zcl_setter_injection_how DEFINITION   "EUR Notes and coins
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS:
      set_cash_provider
        IMPORTING
          i_cash_provider TYPE REF TO zif_cash_provider_howard.
    METHODS:
      get_amount_in_coins
        IMPORTING
          i_amount             TYPE i
...
CLASS zcl_setter_injection_how IMPLEMENTATION.

  METHOD set_cash_provider.
    cash_provider = i_cash_provider.
  ENDMETHOD.

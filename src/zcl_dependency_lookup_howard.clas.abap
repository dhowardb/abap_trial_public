CLASS zcl_dependency_lookup_howard DEFINITION   "EUR Notes and coins
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_dependency_lookup_howard IMPLEMENTATION.

  METHOD get_amount_in_coins.
    DATA(notes) = zcl_cash_provider_factory_how=>create( )->get_notes( 'EUR' ).

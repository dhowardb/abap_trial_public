CLASS zcl_backdoor_injection_how DEFINITION   "EUR Notes and coins
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_backdoor_injection_how IMPLEMENTATION.

  METHOD constructor.
    cash_provider = NEW zcl_cash_provider_howard( ).
  ENDMETHOD.

CLASS zcl_injection_no_interface_how DEFINITION   "EUR Notes and coins
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
  PRIVATE SECTION.
    DATA cash_provider TYPE REF TO lif_cash_provider_howard.
    DATA: change TYPE i.
    METHODS:
      compute_change
        IMPORTING
...
CLASS zcl_injection_no_interface_how IMPLEMENTATION.

  METHOD constructor.
    cash_provider = NEW lcl_cash_provider_howard( ).
  ENDMETHOD.
